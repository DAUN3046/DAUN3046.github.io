...
코치님께서 함수는 최대한 **순수 함수**가 되게끔 해야 된다고 피드백을 주셨다.
...
그 코드는 내가 직접 짤 수 있는 수준이 아니었지만, 적어도 보고 무슨 코드인지 이해하기에 훨씬 수월한 코드가 되었다는 것은 내 부족한 식견으로도 알 수 있었다.
...
```
역시 안 쓸 수 있는 코드라면 머리를 써서 안쓰는 방향으로 하는게 보기도 좋고 관리하기도 편하다.

## 느낀점

> 알고 나니 굳이 복잡하게 코드를 왜 그렇게 썼는지 의문이다. 그런데 방심하면 또 그렇게 작성할 것 같다. 고민을 많이 해야 겠다.

처음 작성할 땐 물흐르듯 당연하게 그렇게 썼는데 지금 보니 당연하지 않았고, 쉬운 길을 두고 복잡해보이게 돌아가는 기분이 드는 코드이다. 그런 면에서 내 코드는 가독성이 좋지 못했다.
